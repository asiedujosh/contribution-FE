...
import { PARCELTABLE } from "../constant/parcelConstant"
import { ParcelApiData } from "../contextApi/parcel/parcelContextApi"
import { Link } from "react-router-dom"

const ParcelTable = () => {
  const { parcelList, searchParcelRecord, processDeleteParcel } =
  ...
  return (
    <>
      <table className="w-full table-auto rounded">
        ...
        >
          {searchParcelRecord.length > 0
            ? searchParcelRecord.map((item) => (
                <tr key={item.id} className="border-t border-gray-200">
                  ...
                  <td className="w-1/4 border border-gray-200 py-4 px-2">
                    <div className="flex space-x-2">
                      ...
                      <span
                        onClick={() => {
                          processDeleteParcel({ id: item.id })
                        }}
